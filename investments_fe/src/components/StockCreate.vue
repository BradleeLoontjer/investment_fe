                  ...
                  <form ref="form">
                    <div class="container-fluid">
                      <div class="row justify-content-around py-2">
                        ...
                        <div class="col col-8">
                          <input v-model="stock.customerId" type="text" class="form-control-sm form-control" required />
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Symbol</label>
                        <div class="col col-8">
                          <input v-model="stock.symbol" type="text" class="form-control-sm form-control" required />
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Name</label>
                        <div class="col col-8">
                          <input v-model="stock.name" type="text" class="form-control-sm form-control" required />
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Shares</label>
                        <div class="col col-8">
                          <input v-model="stock.shares" type="number" class="form-control-sm form-control" required />
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Purchase Price</label>
                        <div class="col col-8">
                          <input v-model="stock.purchasePrice" type="number" class="form-control-sm form-control" required />
                        </div>
                      </div>
                      <div class="form-group row justify-content-around py-2">
                        <label class="col-4">Purchase Date</label>
                        <div class="col col-8">
                          <input v-model="stock.purchaseDate" type="date" class="form-control-sm form-control" required />
                        </div>
                      </div>
