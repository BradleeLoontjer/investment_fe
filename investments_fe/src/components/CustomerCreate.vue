                  ...
                  <form ref="form">
                    <div class="container-fluid">
                      ...
                      <div class="row justify-content-around">
                        <div v-if="!isUpdate" type="button" class="btn btn-primary col-4" @click="createCustomer">
                          Save
                        </div>
                        <div v-if="isUpdate" type="button" class="btn btn-primary col-4" @click="updateCustomer">
                          Update
                        </div>
